 ...
 * <p>
 * For org.mule.runtime.module.launcher.MuleContainer implementation until Mule version 4.5.0
 *
 * @author Manuel Núñez Sánchez (manuel.nunez@hawkore.com)
 */
@Component("SpringMuleContainer")
@ConditionalOnClass(name = SpringMuleContainerV1Impl.MULE_CONTAINER_CLASS)
public class SpringMuleContainerV1Impl extends SpringMuleContainerImpl {

    /**
     * The Mule container class.
     */
    static final String MULE_CONTAINER_CLASS = "org.mule.runtime.module.launcher.MuleContainer";
    private static final Logger LOGGER = LoggerFactory.getLogger(SpringMuleContainerV1Impl.class);
    @Autowired
    ...
    public synchronized void initMuleContainer(ClassLoader classLoader) {
        muleContainer = new MuleContainer(null);
        try {
            // MULE 4.4.0 embedded mode
