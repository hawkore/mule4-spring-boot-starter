...
public class SpringBootMule4RuntimeTestCases extends AbstractSpringTest {
    ...
    public void muleHealthIndicatorOUT_OF_SERVICE_BY_DOMAIN() throws Exception {
        ...
        Assert.assertTrue(muleRuntimeHealthIndicator.health().getStatus().equals(Status.OUT_OF_SERVICE));
    ...
    public void muleCompositeClassLoaderComMuleServices() throws IOException, ClassNotFoundException {
        ...
        container.containerClassLoader().loadClass("com.mulesoft.service.http.impl.service.HttpServiceImplementation");
    }
    ...
    public void muleArtifacts() throws IOException, ClassNotFoundException {
        ...
        Assert.assertEquals(app.hashCode(), app.hashCode());
        ...
        Assert.assertNotEquals(app, domain);
        Assert.assertNotEquals(domain, app);
        Assert.assertNotEquals(app.hashCode(), domain.hashCode());
        Assert.assertEquals(domain, domain);
        Assert.assertEquals(domain.hashCode(), domain.hashCode());
